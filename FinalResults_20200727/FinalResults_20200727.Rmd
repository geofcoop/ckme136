...
#### Dependent variable (y) - Toronto runs scored
```{r}
library(ggplot2)
...
#### Independent variable (x4) - Opposition team DER
```{r warning=FALSE}
require(gridExtra)
...
#### Independent variable (x7) - Cavan Biggio OPS
...
#### Independent variable (x11) - Randal Grichuk OPS
...
#### Independent variable (x12) - Vladimir Guerrero Jr OPS
